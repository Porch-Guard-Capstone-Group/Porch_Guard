...
class _DeliveryState extends State<Delivery>{
  ...
  Widget build(BuildContext context){
    ...
    final provider = ['Amazon', 'Wish', 'Staples', 'Amazon',
      'Best Buy', 'Sephora', 'Microsoft', 'Wish', 'Amazon'];
    final delivery_date = ['Thurs, 20 Nov 2020', 'Wed, 19 Nov 2020', 'Mon, 20 Sept 2020', 'Thurs, 30 Feb 2020',
    ...
    return ListView.builder(
      ...
      return Card(
        child:ListTile(
          ...
          subtitle: Text(delivery_date[index]),
